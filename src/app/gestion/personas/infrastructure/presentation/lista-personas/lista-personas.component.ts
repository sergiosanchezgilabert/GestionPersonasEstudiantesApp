...
import { ContadorComponent } from 'src/app/shared/contador/contador.component';
import { DialogPersonaComponent } from '../dialog-persona/dialog-persona.component';
import { PersonasService } from '../../services/personas-service';
import { ResponseWebPersona } from 'src/app/gestion/personas/domain/IWebPersona';
...
export class ListaPersonasComponent implements OnInit {
  ...
  public personas: Array<ResponseWebPersona> = []
